...
export default function CTFCard({ challenge }: CTFCardProps) {
  const getDifficultyColor = (difficulty: string) => {
    const colors = {
      Fácil: 'text-electric-emerald',
      Medio: 'text-electric-amber',
      Difícil: 'text-electric-rose',
    };
  ...
  const getDifficultyBorder = (difficulty: string) => {
    const borders = {
      Fácil: 'border-electric-emerald/30',
      Medio: 'border-electric-amber/30',
      Difícil: 'border-electric-rose/30',
    };
      ...
      <div className="relative premium-card p-6 hover-lift">
        ...
        <div className="space-y-4 mb-6">
          <div className="grid grid-cols-1 gap-3">
            ...
            <div className="flex items-center justify-between p-3 rounded-lg glass-effect">
              ...
              <span className="text-electric-amber font-bold text-lg">{challenge.points === 0 ? 'Sin Puntaje' : challenge.points}</span>
            </div>
          </div>
        </div>
        ...
        {challenge.writeupUrl && (
          <div className="pt-4 border-t border-slate-700/50">
            ...
            >
              <span className="font-semibold">Ver Writeup</span>
