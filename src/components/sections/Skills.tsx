...
export default memo(function Skills() {
  ...
  return (
    <section id="habilidades" className="section-padding bg-slate-900/50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Experiencia integral en dominios de ciberseguridad
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="premium-card p-8">
            ...
            <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
              Comprometido a mantenerme a la vanguardia de las amenazas y tecnologías emergentes a través de la educación continua y la práctica práctica.
            </p>
