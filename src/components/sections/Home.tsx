...
export default memo(function Home() {
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center section-padding overflow-hidden">
        ...
        <div className="space-y-8 animate-fade-in">
          ...
          <div className="space-y-6">
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl">
              Profesional apasionado de la ciberseguridad especializado en 
              <span className="text-electric-blue font-semibold"> hacking ético</span>,
              <span className="text-electric-purple font-semibold"> evaluación de vulnerabilidades</span>, y
              <span className="text-electric-emerald font-semibold"> soluciones de seguridad impulsadas por IA</span>.
            </p>
            ...
            <div className="premium-card p-4 border-l-4 border-electric-amber">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-electric-amber font-semibold text-sm">Aviso de desarrollo</p>
                  <p className="text-slate-400 text-sm mt-1">
                    Este portafolio está en desarrollo activo. Algunos contenidos representan datos de demostración.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="flex justify-center lg:justify-end animate-slide-left">
          <div className="relative group">
            ...
            <div className="relative w-80 h-80 lg:w-96 lg:h-96">
              {/* Rotating Border */}
              <div className="absolute inset-0 rounded-full border-2 border-transparent bg-gradieProfesional apasionado de la ciberseguridad especializado ennt-to-r from-electric-blue via-electric-purple to-electric-emerald animate-border-flow p-1">
              ...
              <div className="absolute inset-4 rounded-full overflow-hidden group-hover:scale-105 transition-transform duration-500">
                <img
                  src={profile}
                  alt="Ismael Chavez - Cybersecurity Professional"
