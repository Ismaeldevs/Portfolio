...
export default function Contact() {
  return (
    <section id="contacto" className="relative section-padding bg-slate-900/50">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <h2 className="heading-primary text-3xl md:text-5xl mb-4">
            <span className="gradient-text">CONTACTAME</span>
          </h2>
          
          <p className="text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed">
            ¿Listo para colaborar en tu próximo
            <span className="text-electric-blue font-semibold"> proyecto de ciberseguridad</span>?
            Hablemos sobre cómo puedo ayudar a asegurar tus activos digitales.
          </p>
        </div>
        
        <div className="grid lg:grid-cols-1 gap-8 items-stretch">
          {/* Left Column - Contact Information */}
          <div className="flex flex-col space-y-3 animate-slide-right">
            {/* Contact Info Card */}
        ...
        <div className="mt-12 text-center animate-fade-in" style={{ animationDelay: '0.6s' }}>
            ...
            <p className="text-slate-300 mb-4 text-sm leading-relaxed">
              Ya sea que necesites una prueba de penetración, evaluación de vulnerabilidades o consulta de seguridad,
              estoy aquí para ayudar a proteger tus activos digitales con soluciones de ciberseguridad de vanguardia.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="mailto:contact@ismaeldevs.com"
              ...
              >
                ...
                <span className="font-semibold">Envíame un correo electrónico</span>
              </a>
            </div>
        </div>
      </div>
