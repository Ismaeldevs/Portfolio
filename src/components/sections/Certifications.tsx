...
export default function Certifications() {
  const completedCerts = certifications.filter(cert => cert.status === 'completado');
  const inProgressCerts = certifications.filter(cert => cert.status === 'en progreso');

  return (
    <section id="certificaciones" className="relative section-padding bg-slate-900/50">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Certificaciones y credenciales profesionales en
            <span className="text-electric-blue font-semibold"> ciberseguridad</span>,
            <span className="text-electric-purple font-semibold"> hacking ético</span>, y
            <span className="text-electric-emerald font-semibold"> seguridad en la nube</span>
          </p>
        </div>
                ...
                <div className="relative premium-card p-6 hover-lift border-l-4 border-electric-emerald">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between pt-2">
                      <span className="text-slate-400 text-sm">Certificado:</span>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-slate-400">Fecha de Finalización Esperada:</span>
